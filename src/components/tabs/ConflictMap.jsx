...
function AttackRoutes() {
  ...
  useEffect(() => {
    ...
    WAR_DATA.routes.forEach(route => {
      ...
      // Apply CSS animation to the SVG path
      setTimeout(() => {
        if (pl._path) {
        ...
        {!country ? (
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px', paddingBottom: '12px', borderBottom: '1px solid #1e2540' }}>
              <div style={{ width: '12px', height: '12px', borderRadius: '50%', background: country.statusColor, flexShrink: 0, boxShadow: `0 0 8px ${country.statusColor}88` }}></div>
            ...
            <div style={{
              ...
              padding: '3px 8px', borderRadius: '4px', marginBottom: '16px',
