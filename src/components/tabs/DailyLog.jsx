...
export default function DailyLog() {
  ...
  /* ── Shared: accordion rows ── */
  const accordionRows = days.map(d => {
      ...
      >
        <button
          ...
          style={{
            ...
            gap: '8px', padding: isMobile ? '10px 12px' : '11px 14px',
        ...
        >
          ...
          <span style={{ fontSize: '10px', fontFamily: 'monospace', color: '#6b7280', flexShrink: 0, width: isMobile ? '32px' : '44px' }}>
            D{d.day}
          </span>
          {!isMobile && (
          ...
          <span style={{ fontSize: isMobile ? '12px' : '13px', fontWeight: 500, color: isOpen ? '#fff' : '#d1d5db', flex: 1, lineHeight: 1.3 }}>
            {d.title}
          </span>
          <motion.span
            animate={{ rotate: isOpen ? 180 : 0 }}
            transition={{ duration: 0.2 }}
            style={{ color: '#6b7280', fontSize: '10px', flexShrink: 0 }}
          >▼</motion.span>
        </button>
              ...
              <div style={{
                ...
                {d.events.map((e, i) => (
                  <div key={i} style={{ display: 'flex', gap: '7px', marginBottom: '8px' }}>
                    <span style={{ color: sev.color, fontSize: '10px', flexShrink: 0, marginTop: '2px' }}>▸</span>
